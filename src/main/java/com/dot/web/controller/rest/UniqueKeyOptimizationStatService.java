...
import com.dot.dao.UniqueKeyOptzStatDAO;
import com.dot.data.OptimizationStat;
import com.dot.data.model.DataTypeDatabaseModel;

@Controller
@Transactional
@RequestMapping(value = "/UniqueKeyOptimizationStatService")
public class UniqueKeyOptimizationStatService {

	@Autowired
	private UniqueKeyOptzStatDAO dao;
