function dataSizeColumnController($scope, $stateParams, SizeOptimizationStat,
	...
	$scope.columns = function() {
		var res = SizeOptimizationStat.columns(tableId);
	...
	$scope.parentModel = function() {
		var res = SizeOptimizationStat.parentModel(tableId, "TABLE");
		res.success(function(data, status, headers, config) {
	...
	$scope.viewDataWindow = function(id, name) {
		...
		$scope.viewData = function() {
			var res = SizeOptimizationStat.viewData(id);
			res.success(function(data, status, headers, config) {
				// alert(data);
				var allOfTheData = data;
				var dataSource = {
