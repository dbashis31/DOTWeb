function uniqueKeyTableController($scope, $stateParams,
	...
	$scope.tables = function() {
		var res = UniqueKeyOptimizationStat.tables(schemaId);
	...
	$scope.parentModel = function() {
		var res = UniqueKeyOptimizationStat.parentModel(schemaId, "SCHEMA");
		res.success(function(data, status, headers, config) {
...

	{
		...
		headerName : "# Suggested Unique Keys",
