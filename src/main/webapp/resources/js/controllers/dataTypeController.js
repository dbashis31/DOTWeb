function dataTypeController($scope, OptimizationStat) {
	$scope.databaseCount = function() {
		var res = OptimizationStat.databaseCount();
	...
	$scope.schemaCount = function() {
		var res = OptimizationStat.schemaCount();
		res.success(function(data, status, headers, config) {
	...
	$scope.tableCount = function() {
		var res = OptimizationStat.tableCount();
		res.success(function(data, status, headers, config) {
	...
	$scope.columnCount = function() {
		var res = OptimizationStat.columnCount();
		res.success(function(data, status, headers, config) {
	...
	$scope.optimizationStatus = function() {
		var res = OptimizationStat.optimizationStatus();
		res.success(function(data, status, headers, config) {
	...
	$scope.databases = function() {
		var res = OptimizationStat.databases();
		res.success(function(data, status, headers, config) {
			// alert(data);
