function similarTablesController($scope, $stateParams, Similarity) {
	...
	$scope.similarTables = function() {
		var res = Similarity.similarTables("CONTEXT_BASED", id, id1);
	...
	$scope.parentModel = function() {
		var res = Similarity.parentModel(id, id1, "TABLE");
		res.success(function(data, status, headers, config) {
