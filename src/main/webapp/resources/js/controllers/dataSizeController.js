function dataSizeController($scope, SizeOptimizationStat) {
	$scope.databaseCount = function() {
		var res = SizeOptimizationStat.databaseCount();
	...
	$scope.schemaCount = function() {
		var res = SizeOptimizationStat.schemaCount();
		res.success(function(data, status, headers, config) {
	...
	$scope.tableCount = function() {
		var res = SizeOptimizationStat.tableCount();
		res.success(function(data, status, headers, config) {
	...
	$scope.columnCount = function() {
		var res = SizeOptimizationStat.columnCount();
		res.success(function(data, status, headers, config) {
	...
	$scope.optimizationStatus = function() {
		var res = SizeOptimizationStat.optimizationStatus();
		res.success(function(data, status, headers, config) {
	...
	$scope.databases = function() {
		var res = SizeOptimizationStat.databases();
		res.success(function(data, status, headers, config) {
			// alert(data);
