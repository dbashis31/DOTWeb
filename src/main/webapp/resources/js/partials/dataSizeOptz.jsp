...
<html ng-app="dotApp" ng-controller="dataSizeController">
<head>
				...
				<div class="col-md-2">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content"">
							...
							<small>Databases has size optimization scope </small>
				...
				<div class="col-md-2">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							...
							<small>Schemas has size optimization scope</small>
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="font-bold text-navy">
										<small>Tables has size optimization scope</small>
									</div>
								</div>
								<div class="col-md-6">
									<h1 class="no-margins">{{columnCount}}</h1>
									<div class="font-bold text-navy">
										<small>Columns has size optimization scope</small>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-md-4">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content" style="height: 123px;">
							...
							<div class="m-t-sm small">Column Size Optimized</div>
						</div>
					</div>
