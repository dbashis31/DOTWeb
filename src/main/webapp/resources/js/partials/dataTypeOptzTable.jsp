...
<html ng-app="dotApp" ng-controller="dataTypeTableController">
<head>
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a ui-sref="home.dataTypeschema({id:parentModel.id, name:parentModel.name})">{{parentModel.name}}</a></li>
