...
<html ng-app="dotApp" ng-controller="dataSizeTableController">
<head>
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a ui-sref="home.schemaOptimize({id:parentModel.id, name:parentModel.name})">{{parentModel.name}}</a></li>
					<li class="active"><strong>{{schemaName}}</strong></li>
				</ol>
			</div>
						...
						<div class="ibox-title">
							<div class="row">
								<div class="col-sm-9 m-b-xs" style="margin-top: 10px">
									<h5>Table wise optimization status</h5>
								</div>
								<div class="col-sm-3">
