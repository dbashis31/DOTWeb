...
<html ng-app="dotApp" ng-controller="dataTypeColumnController">
<head>
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a
						ui-sref="home.dataTypeschema({id:parentModel.parentModel.id, name:parentModel.parentModel.name})">{{parentModel.parentModel.name}}</a></li>
					<li><a ui-sref="home.dataTypeTable({id:parentModel.id, name:parentModel.name})">{{parentModel.name}}</a></li>
