...
<html ng-app="dotApp" ng-controller="UniqueKeyController">
<head>
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><strong>Unique Key</strong></li>
				</ol>
			</div>
				...
				<div class="col-md-2">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content"">
							...
							<small>Databases has unique key optimization scope </small>
				...
				<div class="col-md-2">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							...
							<small>Schemas has unique key optimization scope</small>
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="font-bold text-navy">
										<small>Tables unique key type optimization scope</small>
									</div>
								</div>
								<!-- <div class="col-md-6">
									<h1 class="no-margins">{{columnCount}}</h1>
									<div class="font-bold text-navy">
										<small>Columns has data type optimization scope</small>
									</div>
								</div> -->
							</div>
						</div>
				...
				<div class="col-md-4">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content" style="height: 123px;">
							...
							<div class="m-t-sm small">Unique Key Optimized</div>
						</div>
					</div>
