...
<html ng-app="dotApp" ng-controller="dataTypeController">
<head>
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><strong>Data Type</strong></li>
				</ol>
			</div>
				...
				<div class="col-md-2">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content"">
							...
							<small>Databases has data type optimization scope </small>
				...
				<div class="col-md-2">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							...
							<small>Schemas has data type optimization scope</small>
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="font-bold text-navy">
										<small>Tables has data type optimization scope</small>
									</div>
								</div>
								<div class="col-md-6">
				...
				<div class="col-md-4">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content" style="height: 123px;">
							...
							<div class="m-t-sm small">Data Type Optimized</div>
						</div>
					</div>
