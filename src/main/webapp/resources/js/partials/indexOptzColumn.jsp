...
<html ng-app="dotApp" ng-controller="indexColumnController">
<head>
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a
						ui-sref="home.indexSchema({id:parentModel.parentModel.id, name:parentModel.parentModel.name})">{{parentModel.parentModel.name}}</a></li>
					<li><a ui-sref="home.indexTable({id:parentModel.id, name:parentModel.name})">{{parentModel.name}}</a></li>
